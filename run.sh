...
#SBATCH -o /m100_work/ICT22_ESP_0/vblasone/rainfall-maps/.log/preprocessing_target.out
#SBATCH -e /m100_work/ICT22_ESP_0/vblasone/rainfall-maps/.log/preprocessing_target.err
...
python3 preprocessing_gripho.py
